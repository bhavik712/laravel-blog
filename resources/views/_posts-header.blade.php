    ...
    <div class="space-y-2 lg:space-y-0 lg:space-x-4 mt-4">
        ...
        > 
            <div x-data="{ show : false }" @click.away="show = false">
                <button @click="show = !show" class="w-full py-2 px-3 font-semibold min-w-32" >
                ...
                <div x-show="show" class=" mt-2 rounded absolute bg-gray-100 w-full min-w-32 max-h-25 overflow-auto" style="display: none">
                    ...
                    @foreach ($categories as $category )
                        <a href="/categories/{{ $category->name }}" class="block px-3 leading-6 hover:bg-blue-500 focus:bg-blue-500 hover:text-white
